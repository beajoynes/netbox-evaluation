...
Frontend?
*  Can you set up schemes and access them straight away? such that you can see for example the MMLite scheme and it's topology
...
* Can it replace active records? MG
* Can it replace EasyIP? MG
* Can it integrate with helix CMBD ? MM/BJ
