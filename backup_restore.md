...
```
beajoynes@test1:~/git/netbox-docker/backups$ docker cp netbox-docker-netbox-1:/opt/netbox/ne
tbox/media .
Successfully copied 39.4kB to /home/beajoynes/git/netbox-docker/backups/.
``` 
